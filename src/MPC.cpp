...
//
// This is the length from front of the car to CoG that has a similar radius (differs according to car shape and size).
 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    // the Solver function below.
	  // fg[0] is the cost function, sum of all components of the cost
	  ...
	  const int delta_change_weight = 300;
